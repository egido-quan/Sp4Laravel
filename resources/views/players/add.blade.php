        ...
        <div class="w-2/5 bg-blue-200 shadow-2xl h-auto p-10 mx-5 rounded-2xl flex flex-col items-center">
            <form class="w-full max-w-sm"  id="nuevo" name="nuevo" method="POST"  action="{{asset('/')}}save" autocomplete="off">
              ...
              <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                  <select class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="playing_hand" name="playing_hand" required>
              ...
              <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                  <select class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="backhand_style" name="backhand_style" required>
                    <option value="">--Select--</option>
