        ...
        <div class="w-2/5 bg-blue-200 shadow-2xl h-auto p-10 mx-5 rounded-2xl flex flex-col items-center">
            <form class="w-full max-w-sm"  id="nuevo" name="nuevo" method="POST"  action="{{asset('/')}}player/{{$player->id}}" autocomplete="off">
              ...
              <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                  <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" id="confAgregar" name="confAgregar" type="submit">
                    Update
                  </button>
                </div>
              </div>
